 ...
 * @author brayan
 */
public class HistorialPrestamosAdmin extends javax.swing.JFrame {
    ...
    public HistorialPrestamosAdmin() {
        initComponents();
    ...
    private void cargarDatos(){
        try {
            ...
            ArrayList<Prestamo> lstPrestamos = new PrestamoDB().obtenerAllPrestamos();
            ...
            for (int i = 0; i < lstPrestamos.size(); i++) {
                ...
                Usuario user = new UsuarioDB().obtenerUsuarioByIdUser(lstPrestamos.get(i).getId_usuario());
            ...
            Logger.getLogger(HistorialPrestamosAdmin.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HistorialPrestamosAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HistorialPrestamosAdmin().setVisible(true);
            }
        });
    }
